...
removeItem(['cool', 'bad', 'cat', 'nice'], 'cool');
...
getValueOfProperty({name: 'Tim', age: 49, gender: 'male'}, age);
...
makeChatMessage('Hello there!', "Ted Tom");

// #14 Create a function called coderTest that takes in an object that is a person, it looks to see if the person’s name is Jeremy and changes
//the person object to have a property called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.
